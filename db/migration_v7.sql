-- =====================================================
-- SilentAlpha Migration v7
-- Fix edge_rank POWER crash for posts with future
-- created_at (caused by client sending local time
-- instead of UTC). Wrap denominator base with
-- GREATEST(..., 0.001) so negative values never
-- reach POWER(negative, 1.5).
-- =====================================================
...
-- Rebuild notifications_with_actor (dropped by CASCADE)
