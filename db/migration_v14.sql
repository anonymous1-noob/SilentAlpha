-- Rebuild posts_with_meta adding author_rank (1–3 = medal, NULL otherwise / anon).
-- Uses LIMIT 3 early-exit so we only pay for counting up to 3 higher scorers.
